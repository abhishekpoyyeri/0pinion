...
class LiveRoomRepository {
  ...
  Future<List<Map<String, dynamic>>> fetchRooms() async {
    try {
      ...
      bool isVisible(Map<String, dynamic> room) {
      ...
      return rooms.where(isVisible).toList();
    } catch (_) {
      ...
      final fallbackRooms = List<Map<String, dynamic>>.from(res);
      ...
      return fallbackRooms.where(isVisible).toList();
    }
  }

  /// Create a new room with a specific duration and return its ID
